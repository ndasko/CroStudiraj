...
public class UcilisteRezultatSastavnica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uciliste_rezultat_sastavnica);

        db = new Baza(this);
        listView = (ListView) findViewById(R.id.list_view);
        data = getIntent().getExtras().getString("uciliste","uciliste");

        Toolbar toolBar = (Toolbar) findViewById(R.id.toolbarUcilisteRezultatSastavnica);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent (UcilisteRezultatSastavnica.this, UcilisteRezultat.class);
